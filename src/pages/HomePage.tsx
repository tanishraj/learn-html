...
export const HomePage = () => {
  const [floatingElements, setFloatingElements] = useState<Array<{ id: number; x: number; y: number; tag: string }>>([]);
        ...
        <div className="w-full px-8 py-20">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto">
              Learn HTML in the most <span className="text-cyan-400 font-bold">futuristic</span> and 
              <span className="text-purple-400 font-bold"> beginner-friendly</span> way possible. 
              Even your grandma could build websites after this!
            </p>
            ...
            >
              <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-sm rounded-2xl p-6 border border-cyan-500/20">
                ...
                <h3 className="text-2xl font-bold text-white mb-1">Zero Jargon</h3>
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20">
                ...
                <h3 className="text-2xl font-bold text-white mb-1">5-Min Lessons</h3>
              ...
              <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20">
                ...
                <h3 className="text-2xl font-bold text-white mb-1">100% Interactive</h3>
