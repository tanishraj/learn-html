...
export const tagDetails: Record<string, TagDetail> = {
  'html': {
    name: 'html',
    definition: 'The <html> tag is the root element of every HTML page. It\'s like the container that holds everything on your webpage - think of it as the main box that contains all other boxes.',
    whenToUse: [
    ...
    attributes: [
      { name: 'lang', description: 'Specifies the language of the page (e.g., "en" for English)', required: false, example: 'lang="en"' },
      { name: 'dir', description: 'Text direction: "ltr" (left-to-right) or "rtl" (right-to-left)', required: false, example: 'dir="ltr"' }
    ],
    relatedTags: [
      { tag: 'head', description: 'Contains metadata about the page' },
      { tag: 'body', description: 'Contains all visible content' },
      { tag: 'DOCTYPE', description: 'Declares the document type (goes before html tag)' }
    ],
    examples: [
      {
    ...
    exercises: [
      {
        ...
        instruction: 'Create a complete HTML structure with html, head, and body tags',
        starterCode: '<!-- Create your HTML structure here -->',
        solution: '<html lang="en">\n  <head>\n    <title>My First Page</title>\n  </head>\n  <body>\n    <p>Hello World!</p>\n  </body>\n</html>',
        hints: ['Start with <html>', 'Add lang="en" attribute', 'Include head and body sections', 'Don\'t forget closing tags']
      }
    ],
    tips: [
  ...
  'head': {
    name: 'head',
    definition: 'The <head> tag contains information ABOUT your webpage that browsers and search engines need, but visitors don\'t see. It\'s like the ID card of your webpage.',
    whenToUse: [
    ...
    attributes: [
      { name: 'profile', description: 'Specifies metadata profiles (rarely used)', required: false, example: 'profile="http://example.com/profile"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Create a head section with title, charset, and viewport meta tags',
        starterCode: '<head>\n  <!-- Add your meta tags and title here -->\n</head>',
        solution: '<head>\n  <title>My Portfolio</title>\n  <meta charset="UTF-8">\n  <meta name="viewport" content="width=device-width, initial-scale=1.0">\n</head>',
        hints: ['Include a descriptive title', 'Add charset="UTF-8"', 'Include viewport meta tag for mobile']
      }
    ],
    tips: [
  ...
  'body': {
    name: 'body',
    definition: 'The <body> tag contains all the content that visitors can see on your webpage - text, images, buttons, everything! It\'s like the main stage where your content performs.',
    whenToUse: [
      'Required in every HTML document',
    ...
    attributes: [
      { name: 'class', description: 'Add CSS classes for styling the entire page', required: false, example: 'class="dark-theme"' },
      { name: 'id', description: 'Unique identifier for the body element', required: false, example: 'id="main-content"' },
      { name: 'onload', description: 'JavaScript to run when page loads', required: false, example: 'onload="welcomeMessage()"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Create a body section with a heading and a paragraph about yourself',
        starterCode: '<body>\n  <!-- Add your content here -->\n</body>',
        solution: '<body>\n  <h1>About Me</h1>\n  <p>Hi! I\'m learning HTML and this is my first webpage.</p>\n</body>',
        hints: ['Start with a heading using h1', 'Add a paragraph with p tag', 'Make it personal and interesting']
      }
    ],
    tips: [
  ...
  'title': {
    name: 'title',
    definition: 'The <title> tag sets the text that appears in your browser tab and bookmark name. It\'s like the name tag of your webpage - what people see when they have your page open.',
    whenToUse: [
      'Required in every HTML document',
    ...
    exercises: [
      {
        ...
        instruction: 'Create a title for a recipe page about chocolate chip cookies',
        starterCode: '<title><!-- Write your title here --></title>',
        solution: '<title>Best Chocolate Chip Cookies Recipe - Easy & Delicious</title>',
        hints: ['Include the main topic (chocolate chip cookies)', 'Add descriptive words (best, easy)', 'Keep it under 60 characters']
      }
    ],
    tips: [
  ...
  'meta': {
    name: 'meta',
    definition: 'The <meta> tag provides information about your webpage to browsers and search engines. Think of it as invisible labels that describe your page - like ingredients on a food package.',
    whenToUse: [
    ...
    attributes: [
      { name: 'charset', description: 'Character encoding (always use UTF-8)', required: false, example: 'charset="UTF-8"' },
      { name: 'name', description: 'Type of metadata (description, viewport, keywords)', required: false, example: 'name="description"' },
      { name: 'content', description: 'The actual metadata content', required: false, example: 'content="A blog about web development"' },
      { name: 'http-equiv', description: 'HTTP header information', required: false, example: 'http-equiv="refresh"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Add charset, viewport, and description meta tags for a personal portfolio site',
        ...
        hints: ['Start with charset="UTF-8"', 'Add viewport for mobile', 'Write a clear description']
      }
    ],
    tips: [
  ...
  'link': {
    name: 'link',
    definition: 'The <link> tag connects your HTML page to external files, most commonly CSS stylesheets. It\'s like telling your webpage "go get that file and use it here."',
    whenToUse: [
    ...
    attributes: [
      { name: 'rel', description: 'Relationship between current page and linked file', required: true, example: 'rel="stylesheet"' },
      { name: 'href', description: 'Path to the external file', required: true, example: 'href="styles.css"' },
      { name: 'type', description: 'MIME type of the linked file', required: false, example: 'type="text/css"' },
      { name: 'media', description: 'When to apply the linked resource', required: false, example: 'media="screen"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Create a link tag to connect a CSS file called "main.css" to your webpage',
        starterCode: '<!-- Add your link tag here -->',
        solution: '<link rel="stylesheet" href="main.css">',
        hints: ['Use rel="stylesheet"', 'Set href to "main.css"', 'Put it in the head section']
      }
    ],
    tips: [
  ...
  'script': {
    name: 'script',
    definition: 'The <script> tag includes JavaScript code in your webpage. JavaScript makes your page interactive - like buttons that do things when clicked, animations, and dynamic content.',
    whenToUse: [
    ...
    attributes: [
      { name: 'src', description: 'Path to external JavaScript file', required: false, example: 'src="script.js"' },
      { name: 'type', description: 'Type of script (usually "text/javascript")', required: false, example: 'type="text/javascript"' },
      { name: 'async', description: 'Load script asynchronously', required: false, example: 'async' },
      { name: 'defer', description: 'Delay script execution until page loads', required: false, example: 'defer' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Create a script tag that shows an alert saying "Hello World!" when the page loads',
        starterCode: '<!-- Add your script tag here -->',
        solution: '<script>\n  alert("Hello World!");\n</script>',
        hints: ['Use opening and closing script tags', 'Put alert("Hello World!"); between them', 'Place it before the closing body tag']
      }
    ],
    tips: [
  ...
  'style': {
    name: 'style',
    definition: 'The <style> tag contains CSS code that controls how your webpage looks - colors, fonts, spacing, layout. It\'s like the paint and decorating instructions for your HTML house.',
    whenToUse: [
    ...
    syntax: '<style>\n  /* CSS rules go here */\n</style>',
    attributes: [
      { name: 'type', description: 'MIME type (usually "text/css")', required: false, example: 'type="text/css"' },
      { name: 'media', description: 'Which devices/conditions the styles apply to', required: false, example: 'media="screen"' }
    ],
    relatedTags: [
      { tag: 'link', description: 'Links to external CSS files' },
    ...
    exercises: [
      {
        ...
        instruction: 'Create a style tag that makes h1 elements red and centers them on the page',
        starterCode: '<style>\n  /* Add your CSS here */\n</style>',
        solution: '<style>\n  h1 {\n    color: red;\n    text-align: center;\n  }\n</style>',
        hints: ['Target h1 elements', 'Use color: red;', 'Use text-align: center;', 'Don\'t forget the semicolons']
      }
    ],
    tips: [
  ...
  'h1': {
    name: 'h1',
    definition: 'The <h1> tag defines the most important heading on a page. Think of it as the main title of a book or newspaper article.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'Add CSS classes for styling', required: false, example: 'class="title primary-heading"' },
      { name: 'id', description: 'Unique identifier for the element', required: false, example: 'id="page-title"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="color: blue; font-size: 2rem;"' }
    ],
    relatedTags: [
  ...
  'p': {
    name: 'p',
    definition: 'The <p> tag defines a paragraph of text. It\'s like a paragraph in a book - a block of related sentences.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'Add CSS classes for styling', required: false, example: 'class="text-content"' },
      { name: 'id', description: 'Unique identifier for the element', required: false, example: 'id="intro-paragraph"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="text-align: center;"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Create two paragraphs: one about your name and one about your hobby',
        starterCode: '<!-- Add two p tags here -->',
        solution: `<p>My name is John and I love coding.</p>
<p>My favorite hobby is playing guitar.</p>`,
        hints: ['Use two separate <p> tags', 'Each paragraph should be complete']
      }
    ],
    tips: [
  ...
  'button': {
    name: 'button',
    definition: 'The <button> tag creates a clickable button. It\'s like a doorbell - press it to make something happen!',
    whenToUse: [
    ...
    attributes: [
      { name: 'type', description: 'Button type: button, submit, or reset', required: false, example: 'type="submit"' },
      { name: 'onclick', description: 'JavaScript to run when clicked', required: false, example: 'onclick="handleClick()"' },
      { name: 'disabled', description: 'Makes button unclickable', required: false, example: 'disabled' },
      { name: 'name', description: 'Name for form submission', required: false, example: 'name="action"' },
      { name: 'value', description: 'Value sent when form is submitted', required: false, example: 'value="save"' },
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="btn btn-primary"' }
    ],
    relatedTags: [
...
<button>Delete</button>`,
        hints: ['Each button needs its own tag', 'Put the text between the tags']
      }
    ],
    tips: [
  ...
  'img': {
    name: 'img',
    definition: 'The <img> tag embeds an image in your webpage. It\'s like placing a photo in a photo album.',
    whenToUse: [
    ...
    attributes: [
      { name: 'src', description: 'Path to the image file', required: true, example: 'src="/images/photo.jpg"' },
      { name: 'alt', description: 'Text description for accessibility', required: true, example: 'alt="A beautiful sunset"' },
      { name: 'width', description: 'Image width in pixels or percentage', required: false, example: 'width="300"' },
      { name: 'height', description: 'Image height in pixels or percentage', required: false, example: 'height="200"' },
      { name: 'loading', description: 'Lazy loading behavior', required: false, example: 'loading="lazy"' },
      { name: 'srcset', description: 'Responsive image sources', required: false, example: 'srcset="img-320w.jpg 320w, img-640w.jpg 640w"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        hints: ['Don\'t forget the src attribute', 'Alt text is important for accessibility']
      }
    ],
    tips: [
  ...
  'a': {
    name: 'a',
    definition: 'The <a> tag creates a hyperlink. It\'s like a teleporter that takes you to another page or location!',
    whenToUse: [
    ...
    attributes: [
      { name: 'href', description: 'URL or path to link to', required: true, example: 'href="https://example.com"' },
      { name: 'target', description: 'Where to open the link', required: false, example: 'target="_blank"' },
      { name: 'title', description: 'Tooltip text on hover', required: false, example: 'title="Visit our homepage"' },
      { name: 'rel', description: 'Relationship to linked page', required: false, example: 'rel="noopener noreferrer"' },
      { name: 'download', description: 'Download the linked resource', required: false, example: 'download="file.pdf"' }
    ],
    relatedTags: [
...
<a href="contact.html">Contact</a>`,
  ...
  'ul': {
    name: 'ul',
    definition: 'The <ul> tag creates an unordered (bullet) list, and <li> tags define each list item. Like a shopping list!',
    whenToUse: [
  ...
  <li>Item 2</li>
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="nav-list"' },
      { name: 'type', description: 'Bullet style (disc, circle, square)', required: false, example: 'type="circle"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="list-style: none;"' }
    ],
    relatedTags: [
  ...
  <li>Sushi</li>
        ...
        hints: ['Start with <ul>', 'Each item needs <li></li>', 'End with </ul>']
      }
    ],
    tips: [
  ...
  'li': {
    name: 'li',
    definition: 'The <li> tag defines a list item. It must be used inside <ul> (unordered list), <ol> (ordered list), or <menu> elements.',
    whenToUse: [
    ...
    attributes: [
      { name: 'value', description: 'Specifies the value of a list item (only for ol)', required: false, example: 'value="5"' },
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="list-item"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="color: red;"' }
    ],
    relatedTags: [
...
<li>Read a book</li>`,
  ...
  'ol': {
    name: 'ol',
    definition: 'The <ol> tag defines an ordered list. An ordered list can be numerical or alphabetical.',
    whenToUse: [
  ...
  <li>Second item</li>
    ...
    attributes: [
      { name: 'type', description: 'Numbering type (1, A, a, I, i)', required: false, example: 'type="A"' },
      { name: 'start', description: 'Starting value of the list', required: false, example: 'start="5"' },
      { name: 'reversed', description: 'List order should be descending', required: false, example: 'reversed' }
    ],
    relatedTags: [
      { tag: 'li', description: 'List item (required child)' },
  ...
  'div': {
    name: 'div',
    definition: 'The <div> tag defines a division or section in an HTML document. It\'s a generic container for grouping elements.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="container card"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="main-content"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="background: blue;"' },
      { name: 'data-*', description: 'Custom data attributes', required: false, example: 'data-user-id="123"' }
    ],
    relatedTags: [
  ...
  'span': {
    name: 'span',
    definition: 'The <span> tag is an inline container used to mark up a part of text or document.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="highlight"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="special-text"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="color: red;"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<p>This <span style="color: red;">word</span> should be red.</p>',
        hints: ['Wrap the word in <span>', 'Add style attribute', 'Use color: red']
      }
    ],
    tips: [
  ...
  'h2': {
    name: 'h2',
    definition: 'The <h2> tag defines the second-level heading. Used for major section titles under the main heading.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="section-title"' },
      { name: 'id', description: 'Unique identifier for anchoring', required: false, example: 'id="introduction"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="color: navy;"' }
    ],
    relatedTags: [
  ...
  'h3': {
    name: 'h3',
    definition: 'The <h3> tag defines the third-level heading. Used for sub-sections within h2 sections.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="subtitle"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="details"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="font-weight: 600;"' }
    ],
    relatedTags: [
      { tag: 'h1', description: 'Main page heading' },
  ...
  'form': {
    name: 'form',
    definition: 'The <form> tag creates an HTML form for user input. Forms are used to collect user data and submit it to a server.',
    whenToUse: [
  ...
  <!-- form elements -->
    ...
    attributes: [
      { name: 'action', description: 'URL where form data is sent', required: false, example: 'action="/api/submit"' },
      { name: 'method', description: 'HTTP method (GET or POST)', required: false, example: 'method="post"' },
      { name: 'name', description: 'Form name for JavaScript', required: false, example: 'name="loginForm"' },
      { name: 'onsubmit', description: 'JavaScript on form submit', required: false, example: 'onsubmit="return validate()"' }
    ],
    relatedTags: [
  ...
  <button type="submit">Send</button>
        ...
        hints: ['Start with <form>', 'Add input elements', 'Include a submit button']
      }
    ],
    tips: [
  ...
  'input': {
    name: 'input',
    definition: 'The <input> tag specifies an input field where users can enter data. The type attribute determines the input behavior.',
    whenToUse: [
      'Text input fields',
    ...
    attributes: [
      { name: 'type', description: 'Input type (text, email, password, etc.)', required: false, example: 'type="email"' },
      { name: 'name', description: 'Field name for form submission', required: false, example: 'name="username"' },
      { name: 'value', description: 'Default or current value', required: false, example: 'value="John"' },
      { name: 'placeholder', description: 'Hint text when empty', required: false, example: 'placeholder="Enter name"' },
      { name: 'required', description: 'Makes field mandatory', required: false, example: 'required' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<input type="email" name="email" required placeholder="your@email.com">',
        hints: ['Set type="email"', 'Add required attribute', 'Include placeholder']
      }
    ],
    tips: [
  ...
  'table': {
    name: 'table',
    definition: 'The <table> tag defines an HTML table for displaying tabular data in rows and columns.',
    whenToUse: [
  ...
  <tr>
    ...
    attributes: [
      { name: 'border', description: 'Table border width', required: false, example: 'border="1"' },
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="data-table"' },
      { name: 'cellpadding', description: 'Space within cells', required: false, example: 'cellpadding="5"' },
      { name: 'cellspacing', description: 'Space between cells', required: false, example: 'cellspacing="0"' }
    ],
    relatedTags: [
  ...
  <tr>
    ...
    <td>$1.00</td>
        ...
        hints: ['Start with <table>', 'Add <tr> for rows', 'Use <th> for headers']
      }
    ],
    tips: [
  ...
  'strong': {
    name: 'strong',
    definition: 'The <strong> tag makes text bold and indicates that the text has strong importance or emphasis.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="important"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="warning-text"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="color: red;"' }
    ],
    relatedTags: [
      { tag: 'em', description: 'Emphasized/italic text' },
    ...
    exercises: [
      {
        ...
        hints: ['Wrap the word in <strong> tags', 'Strong indicates importance']
      }
    ],
    tips: [
  ...
  'em': {
    name: 'em',
    definition: 'The <em> tag makes text italic and indicates emphasis. It shows that text should be stressed when spoken.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="emphasis"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="highlighted"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="color: blue;"' }
    ],
    relatedTags: [
  ...
  'br': {
    name: 'br',
    definition: 'The <br> tag creates a line break. It forces text to start on a new line, like pressing Enter.',
    whenToUse: [
    ...
    syntax: '<br>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="line-break"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="margin: 10px 0;"' }
    ],
    relatedTags: [
  ...
  'hr': {
    name: 'hr',
    definition: 'The <hr> tag creates a horizontal line (rule) across the page. It\'s used to separate content sections.',
    whenToUse: [
    ...
    syntax: '<hr>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="section-divider"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="border: 2px solid blue;"' },
      { name: 'width', description: 'Width of the line (deprecated, use CSS)', required: false, example: 'width="50%"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        starterCode: '<p>About section content.</p>\n<p>Contact section content.</p>',
        solution: '<p>About section content.</p>\n<hr>\n<p>Contact section content.</p>',
  ...
  'blockquote': {
    name: 'blockquote',
    definition: 'The <blockquote> tag represents a section that is quoted from another source. It\'s like a speech bubble for longer quotes.',
    whenToUse: [
    ...
    attributes: [
      { name: 'cite', description: 'URL of the quote source', required: false, example: 'cite="https://example.com/article"' },
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="testimonial"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="font-style: italic;"' }
    ],
    relatedTags: [
  ...
  'code': {
    name: 'code',
    definition: 'The <code> tag displays text as computer code. It uses a monospace font to make code easier to read.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="language-javascript"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="background: #f4f4f4;"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<p>Use the <code>alert()</code> function to show messages.</p>',
  ...
  'pre': {
    name: 'pre',
    definition: 'The <pre> tag displays preformatted text. It preserves spaces, line breaks, and formatting exactly as written.',
    whenToUse: [
    ...
    syntax: '<pre>\nformatted\n    text\n        here\n</pre>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="code-block"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="background: #f8f8f8;"' }
    ],
    relatedTags: [
  ...
  'label': {
    name: 'label',
    definition: 'The <label> tag defines a label for form elements. It helps users understand what each input field is for.',
    whenToUse: [
    ...
    attributes: [
      { name: 'for', description: 'ID of the form element this label belongs to', required: false, example: 'for="email-input"' },
      { name: 'form', description: 'Form ID this label belongs to', required: false, example: 'form="contact-form"' },
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="form-label"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<label for="user-email">Email Address:</label>\n<input type="email" id="user-email" name="email">',
        hints: ['Add label before input', 'Use for attribute matching input id']
      }
    ],
    tips: [
  ...
  'textarea': {
    name: 'textarea',
    definition: 'The <textarea> tag creates a multi-line text input area. Perfect for longer text like comments or messages.',
    whenToUse: [
    ...
    attributes: [
      { name: 'name', description: 'Field name for form submission', required: false, example: 'name="comments"' },
      { name: 'rows', description: 'Number of visible text lines', required: false, example: 'rows="5"' },
      { name: 'cols', description: 'Number of visible character columns', required: false, example: 'cols="40"' },
      { name: 'placeholder', description: 'Hint text when empty', required: false, example: 'placeholder="Enter your message"' },
      { name: 'required', description: 'Makes field mandatory', required: false, example: 'required' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<textarea name="feedback" rows="3" placeholder="Please share your feedback"></textarea>',
        hints: ['Set rows="3"', 'Add placeholder text', 'Include name attribute']
      }
    ],
    tips: [
  ...
  'select': {
    name: 'select',
    definition: 'The <select> tag creates a dropdown list. Users can choose one or more options from the list.',
    whenToUse: [
    ...
    attributes: [
      { name: 'name', description: 'Field name for form submission', required: false, example: 'name="country"' },
      { name: 'multiple', description: 'Allow multiple selections', required: false, example: 'multiple' },
      { name: 'size', description: 'Number of visible options', required: false, example: 'size="3"' },
      { name: 'required', description: 'Makes field mandatory', required: false, example: 'required' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<select name="color">\n  <option value="red">Red</option>\n  <option value="green">Green</option>\n  <option value="blue">Blue</option>\n</select>',
        hints: ['Use <select> tag', 'Add <option> for each color', 'Include value attributes']
      }
    ],
    tips: [
  ...
  'option': {
    name: 'option',
    definition: 'The <option> tag defines an option in a dropdown list. Each option represents a choice users can select.',
    whenToUse: [
    ...
    attributes: [
      { name: 'value', description: 'Value sent when form is submitted', required: false, example: 'value="option1"' },
      { name: 'selected', description: 'Pre-selects this option', required: false, example: 'selected' },
      { name: 'disabled', description: 'Makes option unselectable', required: false, example: 'disabled' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        starterCode: '<select name="pizza-size">\n  <!-- Add options here -->\n</select>',
        solution: '<select name="pizza-size">\n  <option value="small">Small</option>\n  <option value="medium">Medium</option>\n  <option value="large">Large</option>\n</select>',
        hints: ['Add three <option> tags', 'Use lowercase values', 'Capitalize display text']
      }
    ],
    tips: [
  ...
  'header': {
    name: 'header',
    definition: 'The <header> tag represents introductory content. It typically contains navigation, logos, or heading information.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="site-header"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="main-header"' },
      { name: 'role', description: 'ARIA role for accessibility', required: false, example: 'role="banner"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Create a header with a site title and two navigation links',
        starterCode: '<!-- Create page header -->',
        solution: '<header>\n  <h1>My Blog</h1>\n  <nav>\n    <a href="/">Home</a>\n    <a href="/about">About</a>\n  </nav>\n</header>',
        hints: ['Start with <header>', 'Add h1 for title', 'Include nav with links']
      }
    ],
    tips: [
  ...
  'nav': {
    name: 'nav',
    definition: 'The <nav> tag represents a section with navigation links. It helps users and search engines identify navigation areas.',
    whenToUse: [
    ...
    syntax: '<nav>\n  <a href="/home">Home</a>\n  <a href="/about">About</a>\n</nav>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="main-nav"' },
      { name: 'aria-label', description: 'Accessible label for navigation', required: false, example: 'aria-label="Main navigation"' },
      { name: 'role', description: 'ARIA role (usually navigation)', required: false, example: 'role="navigation"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        hints: ['Use <nav> tags', 'Add three <a> links', 'Include href attributes']
      }
    ],
    tips: [
  ...
  'main': {
    name: 'main',
    definition: 'The <main> tag represents the main content of the page. There should only be one main element per page.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="content-area"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="main-content"' },
      { name: 'role', description: 'ARIA role (usually main)', required: false, example: 'role="main"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        hints: ['Start with <main>', 'Add h1 heading', 'Include descriptive paragraph']
      }
    ],
    tips: [
  ...
  'footer': {
    name: 'footer',
    definition: 'The <footer> tag represents footer content. It typically contains copyright info, links, or contact details.',
    whenToUse: [
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="site-footer"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="main-footer"' },
      { name: 'role', description: 'ARIA role for accessibility', required: false, example: 'role="contentinfo"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        hints: ['Use <footer> tags', 'Add copyright symbol &copy;', 'Include privacy link']
      }
    ],
    tips: [
  ...
  'section': {
    name: 'section',
    definition: 'The <section> tag represents a distinct section of content. It groups related content together with a theme.',
    whenToUse: [
    ...
    syntax: '<section>\n  <h2>Section Title</h2>\n  <p>Section content</p>\n</section>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="features-section"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="about-section"' },
      { name: 'aria-label', description: 'Accessible label for section', required: false, example: 'aria-label="Product features"' }
    ],
    relatedTags: [
      { tag: 'article', description: 'Self-contained content' },
    ...
    exercises: [
      {
        ...
        instruction: 'Create a section about services with heading and description',
        starterCode: '<!-- Add services section -->',
        solution: '<section>\n  <h2>Our Services</h2>\n  <p>We provide high-quality services to meet your needs.</p>\n</section>',
        hints: ['Use <section> tags', 'Add h2 heading', 'Include descriptive paragraph']
      }
    ],
    tips: [
  ...
  'article': {
    name: 'article',
    definition: 'The <article> tag represents a complete, self-contained piece of content that could stand alone.',
    whenToUse: [
    ...
    syntax: '<article>\n  <h2>Article Title</h2>\n  <p>Article content</p>\n</article>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="blog-post"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="article-123"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Create an article about a local event with title and content',
        ...
        hints: ['Use <article> tags', 'Add descriptive heading', 'Include event details']
      }
    ],
    tips: [
  ...
  'aside': {
    name: 'aside',
    definition: 'The <aside> tag represents content that is related to the main content but separate from it, like a sidebar.',
    whenToUse: [
      'For sidebar content',
    ...
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="sidebar"' },
      { name: 'id', description: 'Unique identifier', required: false, example: 'id="related-content"' }
    ],
    relatedTags: [
      { tag: 'main', description: 'Main content area' },
      { tag: 'section', description: 'Content sections' },
    ...
    exercises: [
      {
        ...
        hints: ['Use <aside> tags', 'Add a tip heading', 'Include helpful advice']
      }
    ],
    tips: [
  ...
  'video': {
    name: 'video',
    definition: 'The <video> tag embeds video content in your webpage. It allows users to play videos directly in the browser.',
    whenToUse: [
    ...
    attributes: [
      { name: 'src', description: 'Path to the video file', required: false, example: 'src="video.mp4"' },
      { name: 'controls', description: 'Shows play/pause controls', required: false, example: 'controls' },
      { name: 'autoplay', description: 'Automatically starts playing', required: false, example: 'autoplay' },
      { name: 'loop', description: 'Repeats the video', required: false, example: 'loop' },
      { name: 'muted', description: 'Starts muted', required: false, example: 'muted' },
      { name: 'width', description: 'Video width', required: false, example: 'width="320"' },
      { name: 'height', description: 'Video height', required: false, example: 'height="240"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<video src="tutorial.mp4" controls>\n  Your browser does not support video.\n</video>',
        hints: ['Use src attribute', 'Add controls attribute', 'Include fallback text']
      }
    ],
    tips: [
  ...
  'audio': {
    name: 'audio',
    definition: 'The <audio> tag embeds audio content in your webpage. Users can play sound files directly in the browser.',
    whenToUse: [
      'For music or sound effects',
      'Podcast episodes',
      'Audio announcements or instructions'
    ],
    syntax: '<audio src="sound.mp3" controls>\n  Your browser does not support audio.\n</audio>',
    attributes: [
      { name: 'src', description: 'Path to the audio file', required: false, example: 'src="audio.mp3"' },
      { name: 'controls', description: 'Shows play/pause controls', required: false, example: 'controls' },
      { name: 'autoplay', description: 'Automatically starts playing', required: false, example: 'autoplay' },
      { name: 'loop', description: 'Repeats the audio', required: false, example: 'loop' },
      { name: 'muted', description: 'Starts muted', required: false, example: 'muted' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<audio src="song.mp3" controls>\n  Your browser does not support audio.\n</audio>',
        hints: ['Use src for audio file', 'Add controls attribute', 'Include fallback message']
      }
    ],
    tips: [
  ...
  'canvas': {
    name: 'canvas',
    definition: 'The <canvas> tag provides a drawing area for graphics. You can draw shapes, images, and animations using JavaScript.',
    whenToUse: [
    ...
    attributes: [
      { name: 'width', description: 'Canvas width in pixels', required: false, example: 'width="800"' },
      { name: 'height', description: 'Canvas height in pixels', required: false, example: 'height="600"' },
      { name: 'id', description: 'Unique identifier for JavaScript', required: false, example: 'id="drawing-canvas"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<canvas id="myDrawing" width="600" height="400">\n  Canvas not supported in your browser.\n</canvas>',
        hints: ['Set width and height attributes', 'Add an id for JavaScript', 'Include fallback text']
      }
    ],
    tips: [
  ...
  'iframe': {
    name: 'iframe',
    definition: 'The <iframe> tag embeds another webpage or document inside your current page. It\'s like a window to another website.',
    whenToUse: [
      'To embed YouTube videos or maps',
      'Including external content',
      'Displaying other websites safely'
    ],
    syntax: '<iframe src="https://example.com" width="400" height="300">\n  Iframe not supported.\n</iframe>',
    attributes: [
      { name: 'src', description: 'URL of the page to embed', required: true, example: 'src="https://www.youtube.com/embed/video-id"' },
      { name: 'width', description: 'Frame width', required: false, example: 'width="560"' },
      { name: 'height', description: 'Frame height', required: false, example: 'height="315"' },
      { name: 'title', description: 'Accessible description', required: false, example: 'title="YouTube video player"' },
      { name: 'frameborder', description: 'Border around frame (deprecated)', required: false, example: 'frameborder="0"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        solution: '<iframe src="https://www.example.com" width="500" height="400" title="Example website">\n  Iframe not supported.\n</iframe>',
        hints: ['Use src attribute for URL', 'Set width and height', 'Add title for accessibility']
      }
    ],
    tips: [
  ...
  'thead': {
    name: 'thead',
    definition: 'The <thead> tag groups header content in a table. It contains the table headers and helps organize table structure.',
    whenToUse: [
    ...
    syntax: '<thead>\n  <tr>\n    <th>Header 1</th>\n    <th>Header 2</th>\n  </tr>\n</thead>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="table-header"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="background-color: #f0f0f0;"' }
    ],
    relatedTags: [
    ...
    exercises: [
      {
        ...
        instruction: 'Create a thead with headers for Product, Price, and Stock',
        starterCode: '<table>\n  <!-- Add thead here -->\n</table>',
        solution: '<table>\n  <thead>\n    <tr>\n      <th>Product</th>\n      <th>Price</th>\n      <th>Stock</th>\n    </tr>\n  </thead>\n</table>',
        hints: ['Use <thead> to wrap headers', 'Add <tr> for the row', 'Use <th> for each header']
      }
    ],
    tips: [
  ...
  'tbody': {
    name: 'tbody',
    definition: 'The <tbody> tag groups the body content in a table. It contains the main data rows separate from headers.',
    whenToUse: [
    ...
    syntax: '<tbody>\n  <tr>\n    <td>Data 1</td>\n    <td>Data 2</td>\n  </tr>\n</tbody>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="table-body"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="background-color: white;"' }
    ],
    relatedTags: [
      { tag: 'table', description: 'Table container' },
      { tag: 'thead', description: 'Table header group' },
    ...
    exercises: [
      {
        ...
        solution: '<table>\n  <thead>\n    <tr><th>Item</th><th>Price</th></tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td>Apple</td>\n      <td>$1.00</td>\n    </tr>\n    <tr>\n      <td>Banana</td>\n      <td>$0.50</td>\n    </tr>\n  </tbody>\n</table>',
        hints: ['Use <tbody> to wrap data rows', 'Add <tr> for each row', 'Use <td> for data cells']
      }
    ],
    tips: [
  ...
  'tr': {
    name: 'tr',
    definition: 'The <tr> tag defines a table row. It contains table cells (th or td) that make up the columns.',
    whenToUse: [
    ...
    syntax: '<tr>\n  <td>Cell 1</td>\n  <td>Cell 2</td>\n</tr>',
    attributes: [
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="data-row"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="background-color: #f9f9f9;"' }
    ],
    relatedTags: [
      { tag: 'table', description: 'Table container' },
      { tag: 'td', description: 'Table data cell' },
    ...
    exercises: [
      {
        ...
        instruction: 'Create a table row with product name, price, and quantity',
        starterCode: '<!-- Add table row -->',
        solution: '<tr>\n  <td>Laptop</td>\n  <td>$999</td>\n  <td>5</td>\n</tr>',
        hints: ['Use <tr> for the row', 'Add three <td> elements', 'Include product details']
      }
    ],
    tips: [
  ...
  'th': {
    name: 'th',
    definition: 'The <th> tag defines a header cell in a table. It\'s bold and centered by default, making it perfect for column titles.',
    whenToUse: [
    ...
    attributes: [
      { name: 'scope', description: 'Defines what the header applies to', required: false, example: 'scope="col"' },
      { name: 'colspan', description: 'Number of columns to span', required: false, example: 'colspan="2"' },
      { name: 'rowspan', description: 'Number of rows to span', required: false, example: 'rowspan="3"' },
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="header-cell"' }
    ],
    relatedTags: [
      { tag: 'td', description: 'Table data cell' },
    ...
    exercises: [
      {
        ...
        instruction: 'Create headers for a student grade table: Name, Math, Science, English',
        starterCode: '<tr>\n  <!-- Add header cells -->\n</tr>',
        solution: '<tr>\n  <th>Name</th>\n  <th>Math</th>\n  <th>Science</th>\n  <th>English</th>\n</tr>',
        hints: ['Use <th> for each header', 'Add four header cells', 'Use descriptive text']
      }
    ],
    tips: [
  ...
  'td': {
    name: 'td',
    definition: 'The <td> tag defines a standard data cell in a table. It contains the actual information displayed in table rows.',
    whenToUse: [
    ...
    attributes: [
      { name: 'colspan', description: 'Number of columns to span', required: false, example: 'colspan="2"' },
      { name: 'rowspan', description: 'Number of rows to span', required: false, example: 'rowspan="3"' },
      { name: 'class', description: 'CSS classes for styling', required: false, example: 'class="data-cell"' },
      { name: 'style', description: 'Inline CSS styles', required: false, example: 'style="text-align: center;"' }
    ],
    relatedTags: [
      { tag: 'th', description: 'Table header cell' },
    ...
    exercises: [
      {
        ...
        starterCode: '<tr>\n  <!-- Add data cells -->\n</tr>',
        solution: '<tr>\n  <td>Alice</td>\n  <td>95</td>\n  <td>88</td>\n  <td>92</td>\n</tr>',
        hints: ['Use <td> for each data cell', 'Add four cells', 'Include name and grades']
      }
    ],
    tips: [
